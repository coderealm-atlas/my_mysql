-- migrate:up
-- Sakila Sample Database Schema for Integration Testing
-- Simplified version for testing purposes

-- Core tables for DVD rental business
...
-- Add foreign key constraint to store table (requires staff table to exist first)
